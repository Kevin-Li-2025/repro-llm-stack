# Research positioning (how to talk about this project honestly)

Top programs and strong industry labs rarely reward “I can call APIs” alone. **This repository is not a new algorithm paper.** Its defensible story is **measurement + data governance + reproducible experimental protocol** around standard post-training.
...
Claiming otherwise in interviews will backfire.
...
## The sentence you want in a personal statement or interview
...
- If targeting research programs, pick **one axis** to deepen next (e.g. *data-centric* study on filtering / synthetic mix rates, or *alignment* study on off-policy DPO assumptions) and cite this repo as **infrastructure**.

## CPT scope

CPT in this repo is a **wiring + smoke** path plus documentation for scale (`docs/CPT_AND_PRETRAIN.md`). Framing: “I know where CPT sits in the lifecycle and how I would bolt large-scale pretrain on — here is the minimal executable slice.”
