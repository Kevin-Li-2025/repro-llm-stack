...
These files can be large; committing them is optional. The usual outputs worth keeping alongside this directory are the **generated Markdown comparison table** and the **exact commands** documented in `docs/RESULTS.md`.
